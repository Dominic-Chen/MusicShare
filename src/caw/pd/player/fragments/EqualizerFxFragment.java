...
public class EqualizerFxFragment extends Fragment {
	...
	private void initFragmentView(ViewGroup container) {
		//mStatusTextView = new TextView(getActivity());
		if(!isInitialized){
			mSwitchView=new Switch(getActivity());
		
			mLinearLayout = new LinearLayout(getActivity());
			mLinearLayout.setOrientation(LinearLayout.VERTICAL);
			//mLinearLayout.addView(mStatusTextView);
	        mLinearLayout.addView(mSwitchView);
		}
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		initFragmentView(container);
		if(!isInitialized){
			isInitialized=true;
		}
		MessageDispatcher.sendEqualizerEnableMessage(getActivity(),false);
	...
	private void setupEqualizerFxAndUI() {
		...
		if(!isInitialized&&PlayerService.mplayer!=null){
        ...
        for (short i = 0; i < bands; i++) {
            ...
            bar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
                public void onProgressChanged(SeekBar seekBar, int progress,
                	...
                	//MessageDispatcher.sendEqualizerConfMessage(getActivity(), band, (short) (progress + minEQLevel));
                }
